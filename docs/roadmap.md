...
through comparators, observers, pistons and TNT, saves, mods, the admin
panel, voice relaying and anti-cheat.
...
2. **Hoppers and rails** – moving items between containers, and minecarts (the rest of redstone is done: wire, torches, levers, buttons, plates, repeaters, comparators, observers, pistons, dispensers, droppers, note blocks, lamps, doors and TNT).
