...
command set, block breaking, sky and block lighting, saves, mods, the admin
...
5. **Vanilla-compatible terrain** – reproduce Mojang's noise generator from the datapack settings so seeds match.
6. **Redstone**.
