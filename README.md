...
Garnet is early. Players can join, see the world (with real sky and block lighting), move, chat, break and place blocks with real inventories and drops; the vanilla command set ([docs/commands.md](docs/commands.md)), mods, the panel, voice relay and anti-cheat work. Inventories, mobs, redstone, combat and vanilla terrain generation are on the roadmap ([docs/roadmap.md](docs/roadmap.md)).
